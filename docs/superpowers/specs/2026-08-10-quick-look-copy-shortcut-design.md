...
5. Hover actual rendered glyphs and verify the cursor changes to the I-beam; verify same-line trailing whitespace and page whitespace remain arrows; hover a link or enabled button and verify it becomes a pointer.
